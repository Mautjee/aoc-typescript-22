        ...
        if x[-1] == '.':
            if len(pointer) > 1:
                for t in range(len(pointer)-1):
                    ...
                    alle_dir[tuple_pointer[t+1]]['filesize_dirs'] += alle_dir[tuple_pointer[t]]['file_size_tot']
                    alle_dir[tuple_pointer[t+1]]['tot_size']       = alle_dir[tuple_pointer[t+1]]['file_size_tot'] + alle_dir[tuple_pointer[t+1]]['filesize_dirs']
                    pointer.reverse()
